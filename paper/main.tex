...
tokens. This supports a concrete runtime requirement: rollout workers must
control chat-template and decoding protocol per action channel, not simply call
a model endpoint and hope for a valid tool call.
