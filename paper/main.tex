...
action generation, the same model solves all nine episodes, with 9/9 parsed
actions and 9/9 successful executions. This supports a concrete runtime
...
default and thinking-disabled structured action protocols.}
